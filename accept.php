...
if (isset($_POST['accept'])) {
    ...
    $update_sql = "UPDATE `graduation_data` SET approval_status = 'approved' WHERE student_id = '$student_id'";
    ...
    if ($update_result) {
        ...
        $_SESSION['approvalStatus'] = "Approved";

        $approvalStatus = "Approved";
        // header("Location: hod_dashboard.php");

        echo '<script type="text/javascript">
        window.location.href = "hod_dashboard.php?student_id=' . $student_id . '";
        </script>';
