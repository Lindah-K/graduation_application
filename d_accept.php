...
if (isset($_POST['accept'])) {
    ...
    $update_sql = "UPDATE `graduation_data` SET d_approvalstatus = 'approved' WHERE student_id = '$student_id'";
    ...
    if ($update_result) {
        ...
        $_SESSION['d_approvalstatus'] = "Approved";

        $d_approvalstatus = "Approved";
